...
class Ui_Viewport(object):
    def setupUi(self, Viewport):
        Viewport.setObjectName("Viewport")
        Viewport.resize(327, 651)
...
"          }\n"
"    ")
        self.gridLayout_4 = QtWidgets.QGridLayout(Viewport)
        self.gridLayout_4.setContentsMargins(5, 0, 5, 0)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.wgt_img = QtWidgets.QWidget(Viewport)
        self.wgt_img.setAutoFillBackground(False)
        self.wgt_img.setObjectName("wgt_img")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.wgt_img)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setSpacing(0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.plot_img = GraphicsLayoutWidget(self.wgt_img)
        self.plot_img.setObjectName("plot_img")
        self.gridLayout_2.addWidget(self.plot_img, 0, 0, 1, 1)
        self.gridLayout_4.addWidget(self.wgt_img, 0, 0, 1, 2)
        self.wgt_ft = QtWidgets.QWidget(Viewport)
        self.wgt_ft.setObjectName("wgt_ft")
        self.gridLayout = QtWidgets.QGridLayout(self.wgt_ft)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.layout_ft = QtWidgets.QVBoxLayout()
        self.layout_ft.setObjectName("layout_ft")
        self.cmbx_ft = QtWidgets.QComboBox(self.wgt_ft)
        self.cmbx_ft.setMaximumSize(QtCore.QSize(16777215, 20))
        self.cmbx_ft.setObjectName("cmbx_ft")
        self.cmbx_ft.addItem("")
        self.cmbx_ft.addItem("")
        self.cmbx_ft.addItem("")
        self.cmbx_ft.addItem("")
        self.layout_ft.addWidget(self.cmbx_ft)
        self.plot_ft = GraphicsLayoutWidget(self.wgt_ft)
        self.plot_ft.setObjectName("plot_ft")
        self.layout_ft.addWidget(self.plot_ft)
        self.gridLayout.addLayout(self.layout_ft, 0, 0, 1, 1)
        self.gridLayout_4.addWidget(self.wgt_ft, 1, 0, 1, 2)

        self.retranslateUi(Viewport)
        QtCore.QMetaObject.connectSlotsByName(Viewport)

    def retranslateUi(self, Viewport):
        _translate = QtCore.QCoreApplication.translate
        Viewport.setWindowTitle(_translate("Viewport", "Form"))
        self.cmbx_ft.setItemText(0, _translate("Viewport", "FT Magnitude"))
        self.cmbx_ft.setItemText(1, _translate("Viewport", "FT Phase"))
        self.cmbx_ft.setItemText(2, _translate("Viewport", "FT Real"))
        self.cmbx_ft.setItemText(3, _translate("Viewport", "FT Imaginary"))
